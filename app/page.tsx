...
import { LastShareWidget } from '@/app/components/LastShareWidget';
...
export default async function HomePage({ searchParams }: HomePageProps) {
  ...
  return (
    <main className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center overflow-x-clip px-5 py-16 md:px-10 md:py-20">
      ...
      <LastShareWidget locale={locale} messages={messages.lastShare} />
    </main>
  );
}
